...
public class ClientServerCommsIntegrationTest {
	...
	@Mock
	private TimingPointService mockServerService;
	...
	public void before() {
		...
		TimingPointServiceHandlers.bindHandlers(this.rpcServer, this.mockServerService);
	...
	public void testStartingATimingPointOnTheClientInvokesTheStartTimingPointMethodOnTheServer() {
		...
		verify(this.mockServerService, timeout(SERVER_RECEIVE_MESSAGE_TIMEOUT_MILLIS)).startTimingPoint(TIMING_POINT_ID, TIMING_POINT_NAME);
	}
	...
	public void testStoppingATimingPointOnTheClientInvokesTheStopTimingPointMethodOnTheServer() {
		...
		verify(this.mockServerService, timeout(SERVER_RECEIVE_MESSAGE_TIMEOUT_MILLIS)).stopTimingPoint(TIMING_POINT_ID, TIMING_POINT_NAME);
	}
}